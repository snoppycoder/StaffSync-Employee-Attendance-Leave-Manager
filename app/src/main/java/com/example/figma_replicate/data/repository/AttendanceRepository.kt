...
class AttendanceRepository @Inject constructor(
    ...
    suspend fun getAttendanceStats(startDate: String? = null, endDate: String? = null): Result<AttendanceStats> {
        return try {
            Result.success(apiService.getAttendanceStats(startDate, endDate))
        } catch (e: Exception) {
            Result.failure(e)
        }
    }
